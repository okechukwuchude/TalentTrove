...
import type { SettingKey } from './settings-registry.ts';
...
export async function getSecretSetting(key: SettingKey): Promise<string | null> {
...
export async function setSecretSetting(key: SettingKey, value: string): Promise<void> {
