...
describe('settings-registry', () => {
  it('has exactly the ten expected setting keys with correct secret flags', () => {
    ...
    expect(actual).toEqual([
      ...
      { key: 'adzuna_countries', secret: false },
      { key: 'adzuna_queries', secret: false },
      { key: 'ashby_companies', secret: false },
      { key: 'greenhouse_companies', secret: false },
      { key: 'jsearch_api_key', secret: true },
      { key: 'jsearch_country', secret: false },
      { key: 'jsearch_queries', secret: false },
